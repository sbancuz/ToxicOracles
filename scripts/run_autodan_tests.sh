...
for model in "${models[@]}"; do
  # conda run -n toxic_oracles_autodan python autodan_ga_eval.py --model "${model}" --data "./data/EvoTox/questions_reduced100.csv" --save_suffix "${model}" --num_steps 10 --batch_size 6 --num_elites 0.167
  ...
  conda run -n toxic_oracles_autodan python autodan_hga_eval.py --model "${model}" --data "./data/EvoTox/questions_reduced100.csv" --num_steps 10 --batch_size 6 --num_elites 0.167
